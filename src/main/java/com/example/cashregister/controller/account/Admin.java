...
@WebServlet(name = "CashierAcc", value = "/acc/admin")
public class Admin extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        int amount = userDao.countRows();
        int limto = page * perpage;
        int limfrom = limto - perpage;
        int amountpages = amount / perpage;

        req.setAttribute("users", userDao.getAllUsers(col, dir, limfrom, limto));
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        req.setAttribute("search",userDao.searchUser((String) req.getParameter("fullname")));
        doGet(req, resp);
    }
