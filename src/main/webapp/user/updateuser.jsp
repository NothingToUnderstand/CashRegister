...
<form method="POST" action="${pageContext.request.contextPath}/update/user">
    <table border="0">
        ...
        <tr>
            <td>First Name:</td>
            <td><input type="text" name="firstname" value="<%=request.getParameter("firstname").replaceAll("\\s","")%>" required pattern="^[A-ZА-ЯЁ]{1}[A-Za-zА-Яа-яЁё]{2,}"/></td>
        </tr>
        <tr>
            <td>Last Name:</td>
            <td><input type="text" name="lastname" value="<%=request.getParameter("lastname").replaceAll("\\s","")%>" required pattern="^[A-ZА-ЯЁ]{1}[A-Za-zА-Яа-яЁё]{2,}"/></td>
        </tr>
        <tr>
            <td>Password:</td>
            <td><input type="password" name="password" value="${password}" required pattern="[A-ZА-ЯЁ]{1,}[A-Za-zА-Яа-яЁё]{3,}[0-9]{3,}"/></td>
        </tr>
        <tr>
            <td>Role :</td>
