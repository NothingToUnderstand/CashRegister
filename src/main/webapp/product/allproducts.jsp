...
<a class="btn btn-success btn-sm" href="${pageContext.request.contextPath}/create/product">Create Product</a>
<a class="btn btn-dark btn-sm" href="${pageContext.request.contextPath}/">Back</a>
...
<div class="form-inline" style="float: right;">
    <form action="${pageContext.request.contextPath}/all/products" method="post">
        <input  class="form-control form-control-sm" type="text" placeholder="Search.." value="${name}" name="name">
...
<table id="products" class="table">
    ...
    <c:forEach items="${products}" var="product">
        <tr>
           ...
           &quantity=${product.getQuantity()}&weight=${product.getWeight()}&price=${product.getPrice()}"><fmt:message
                    key="update"/></a></td>
            <td><a class="btn btn-danger"
                   href="${pageContext.request.contextPath}/delete/product?id=${product.getId()}"><fmt:message
                    key="delete"/></a></td>
        </tr>
    </c:forEach>
    </tbody>
